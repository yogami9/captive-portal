...
function() {
  ...
  Inline.prototype.createButton = function() {
    var t, e = this;
    e.defaults.customButton ? (t = document.getElementById(e.defaults.customButton)).setAttribute("data-paystack", e.defaults.id) : ((t = document.createElement("button")).innerHTML = "<span class='paystack-top-blue'>Pay Securely with Paystack</span><span class='paystack-body-image'> </span>", t.setAttribute("class", "paystack-trigger-btn"), t.setAttribute("data-paystack", e.defaults.id), sourceScript.parentNode.insertBefore(t, sourceScript.nextSibling)),
  ...
  Inline.prototype.openNewCheckout = function() { ! this.iframe || this.isIframeOpen || this.isEmbed || (this.background.style.display = "", this.background.style.visibility = "visible", this.iframe.style.display = "", this.iframe.contentWindow.postMessage("render", "*"), this.isIframeOpen = !0)
  },
  ...
  function randomId() {
    ...
    n = 0; n < 5; n++) t += e.charAt(Math.floor(Math.random() * e.length));
    return t
  }
  function isValid(t) {
  ...
  function parseResponse(t, e) {
    ...
    n && (i = (r = t.split(" "))[1], a = r.slice(2).join(" "), o = e.id == i),
    {
      action: n,
      isThisIframe: o,
      data: a
  ...
  function cssLoad(t, e) {
    ...
    void 0 !== u.addEventListener ? (u.addEventListener("load", d, !1), u.addEventListener("error", l, !1)) : void 0 !== u.attachEvent && u.attachEvent("onload",
    function() {
      var t, e = document.styleSheets.length;
      try {
        for (; e--;) if ((t = document.styleSheets[e]).id === r) return t.cssText,
        void d()
      } catch(t) {}
      s || l()
    }),
...
function(t) {
  ...
  function g() {
    ...
    this._initBody = function(t) {
      if (this._bodyInit = t) if ("string" == typeof t) this._bodyText = t;
      ...
      else if (i && o && s(t)) this._bodyArrayBuffer = v(t.buffer),
...
function() {
  ...
  function c(t) {
    ...
    for (var e = 0,
    n = t._deferreds.length; e < n; e++) i(t, t._deferreds[e]);
    t._deferreds = null
  }
  function d(t, e) {
    var n = !1;
  ...
  a.race = function(i) {
    return new a(function(t, e) {
      for (var n = 0,
      r = i.length; n < r; n++) i[n].then(t, e)
    })
  },
  a._immediateFn = "function" == typeof setImmediate &&
  function(t) {
    setImmediate(t)
  } ||
  function(t) {
  ...
  n.Promise ? n.Promise.prototype.
  finally || (n.Promise.prototype.
  finally = t) : n.Promise = a
});